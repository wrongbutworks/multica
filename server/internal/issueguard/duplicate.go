...
func LockAndFindActiveDuplicate(
	...
	if err := q.LockIssueDuplicateKey(ctx, lockKey(workspaceID, spaceID, projectID, parentIssueID, normalizedTitle)); err != nil {
...
func lockKey(workspaceID, spaceID, projectID, parentIssueID pgtype.UUID, normalizedTitle string) string {
	return strings.Join([]string{
		"issue-active-duplicate",
		util.UUIDToString(workspaceID),
		util.UUIDToString(spaceID),
